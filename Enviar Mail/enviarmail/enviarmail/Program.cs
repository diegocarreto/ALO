    ...
    class Program
    {
        static void Main(string[] args)
        {
           ...
           //Creamos un nuevo Objeto de mensaje
            ...
            mmsg.To.Add("eg@aloalo.mx,la@aloalo.mx,eo@aloalo.mx,diego.ao.carreto@gmail.com");

            //Nota: La propiedad To es una colección que permite enviar el mensaje a más de un destinatario

            //Asunto
            mmsg.Subject = "Cotización";
            ...
            mmsg.From = new System.Net.Mail.MailAddress("cotizaciones@alopruebas.com.mx");
            ...
            cliente.Credentials =
                new System.Net.NetworkCredential("cotizaciones@alopruebas.com.mx", "Cbcl04?1");
